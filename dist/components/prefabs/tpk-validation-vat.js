...
class TpkValidationVATPrefab extends Component {
  ibanMaskByCountry = [{
    mask: '$$&&&&&&&&&&',
    startsWith: 'BE',
...
export { TpkValidationVATPrefab as default };
