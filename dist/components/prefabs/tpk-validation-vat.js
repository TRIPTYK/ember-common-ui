...
var _class, _TpkValidationVATPrefabComponent;
let TpkValidationVATPrefabComponent = (_class = (_TpkValidationVATPrefabComponent = class TpkValidationVATPrefabComponent extends Component {
  constructor(...args) {
    super(...args);
...
}, setComponentTemplate(precompileTemplate("\n    <TpkValidationInputComponent @label={{@label}} @type=\"text\" @onChange={{this.onChange}} @validationField={{@validationField}} @changeEvent={{@changeEvent}} @disabled={{@disabled}} @changeset={{@changeset}} @mandatory={{@mandatory}} @mask={{this.ibanMaskByCountry}} @maskOptions={{this.maskOptions}} @requiredFields={{@requiredFields}} as |V|>\n      <V.Label class=\"tpk-vat-container\" data-test-tpk-prefab-vat-container data-has-error=\"{{V.hasError}}\" anchorScrollUp={{@validationField}} ...attributes>\n        <MandatoryLabelComponent class=\"tpk-label\" @label={{@label}} @mandatory={{V.mandatory}} />\n        <V.Input class=\"tpk-vat-input uppercase\" data-test-tpk-vat-input />\n        <TpkValidationErrorsComponent class=\"tpk-validation-errors\" @errors={{V.errors}} />\n      </V.Label>\n    </TpkValidationInputComponent>\n  ", {
  strictMode: true,
  scope: () => ({
    TpkValidationInputComponent,
...
}), _TpkValidationVATPrefabComponent), _TpkValidationVATPrefabComponent), _applyDecoratedDescriptor(_class.prototype, "onChange", [action], Object.getOwnPropertyDescriptor(_class.prototype, "onChange"), _class.prototype), _class);
