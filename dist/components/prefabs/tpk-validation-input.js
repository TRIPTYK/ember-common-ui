...
class TpkValidationInputPrefab extends Component {
  ...
  static {
    setComponentTemplate(precompileTemplate("<TpkValidationInput @type={{@type}} @label={{@label}} @disabled={{@disabled}} @changeEvent={{@changeEvent}} @onChange={{@onChange}} @placeholder={{@placeholder}} @validationField={{@validationField}} @mask={{@mask}} @mandatory={{@mandatory}} @maskOptions={{@maskOptions}} @unmaskValue={{@unmaskValue}} @changeset={{@changeset}} @requiredFields={{@requiredFields}} as |V|>\n  <V.Label class=\"tpk-input-container\" data-test-tpk-prefab-input-container={{@validationField}} data-has-error=\"{{V.hasError}}\" {{!-- @glint-ignore --}} anchorScrollUp={{@validationField}} ...attributes>\n    <MandatoryLabelComponent class=\"tpk-label\" @label={{@label}} @mandatory={{V.mandatory}} />\n    <V.Input class=\"tpk-input-input\" data-test-tpk-input-input />\n    <TpkValidationErrorsComponent class=\"tpk-validation-errors\" @errors={{V.errors}} />\n  </V.Label>\n</TpkValidationInput>", {
      strictMode: true,
      scope: () => ({
        TpkValidationInput,
...
export { TpkValidationInputPrefab as default };
