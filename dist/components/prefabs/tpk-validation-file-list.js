...
class TpkValidationFileList extends Component {
  handleDrop(event) {
    event.preventDefault();
...
export { FileList, TpkValidationFileList as default };
