      ...
      items: [
        {
          ...
          route: 'dashboard.docs.ember-input-validation.prefabs.input',
          icon: <template>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-4"><path d="M12 20V10M5 20h14a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2z"></path></svg>
          </template> as TOC<{ Element: SVGSVGElement }>
        },
        {
          type: 'link',
      ...
      >
        <:header>
          <div class="flex flex-col items-center justify-center p-2">
            <img src="/assets/img/ember_common_ui_logo.svg" alt="EMBER COMMON UI" class="w-24 object-contain" />
        ...
        <:footer>
          <div class="flex items-center justify-between w-full p-2 px-4 gap-3 {{if this.sidebarCollapsed "flex-col" "flex-row"}}">
            <div class="flex items-center gap-3 {{if this.sidebarCollapsed "flex-col" "flex-row"}}">
              <a href="https://github.com/triptyk/ember-common-ui" target="_blank" rel="noopener noreferrer" class="tooltip {{if this.sidebarCollapsed "tooltip-right" "tooltip-top"}}" data-tip="GitHub">
                <svg class="size-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" />
                </svg>
              </a>
              <a href="https://triptyk.eu" target="_blank" rel="noopener noreferrer" class="tooltip {{if this.sidebarCollapsed "tooltip-right" "tooltip-top"}}" data-tip="Our website">
                <svg class="size-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  <circle cx="12" cy="12" r="10" />  <line x1="2" y1="12" x2="22" y2="12" />  <path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z" />
                </svg>
              </a>
              <a href="https://facebook.com/triptykdigital" target="_blank" rel="noopener noreferrer" class="tooltip {{if this.sidebarCollapsed "tooltip-right" "tooltip-top"}}" data-tip="Facebook">
                <svg class="size-5" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                  <path stroke="none" d="M0 0h24v24H0z"/>  <path d="M7 10v4h3v7h4v-7h3l1 -4h-4v-2a1 1 0 0 1 1 -1h3v-4h-3a5 5 0 0 0 -5 5v2h-3" />
                </svg>
              </a>
            </div>
