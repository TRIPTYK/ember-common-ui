...
export default class PasswordPrefabDocs extends Component<PasswordPrefabDocsSignature> {
  ...
  <template>
    <DocPage
      @title={{t "emberInputValidation.prefabs.password.title"}}
      @description={{t "emberInputValidation.prefabs.password.description"}}
    >
      <DocSection
        @title={{t "emberInputValidation.prefabs.password.examples.title"}}
      >
        <CodeExampleComponent
          @title={{t "emberInputValidation.prefabs.password.examples.basic"}}
        >
          <:demo>
            <div class="flex gap-4">
              <BasicPasswordExample />
              <DisabledPasswordExample />
              <ErrorPasswordExample />
            </div>
          </:demo>
          <:template>
            <CodeBlock @code={{this.password}} @language="gts" />
          </:template>
        </CodeExampleComponent>
      </DocSection>
