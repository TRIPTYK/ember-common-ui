...
import type TpkValidationRadioGroup from './tpk-validation-radio-group';
...
export interface ChangesetFormSignature<S extends ZodObject, T extends ImmerChangeset<DeepNothing<z.infer<S>>>> {
    Args: ChangesetFormComponentArgs<S, T>;
    Blocks: {
        default: [
            {
                TpkInput: WithBoundArgs<typeof TpkValidationInput, 'changeset' | 'disabled' | 'requiredFields'>;
                TpkInputPrefab: WithBoundArgs<typeof TpkValidationInputPrefabComponent, 'changeset' | 'disabled' | 'requiredFields'>;
                TpkTextarea: WithBoundArgs<typeof TpkValidationTextarea, 'changeset' | 'disabled' | 'requiredFields'>;
                ...
                TpkCheckbox: WithBoundArgs<typeof TpkValidationCheckbox, 'changeset' | 'disabled' | 'requiredFields'>;
                TpkCheckboxPrefab: WithBoundArgs<typeof TpkValidationCheckboxPrefabComponent, 'changeset' | 'disabled' | 'requiredFields'>;
                TpkRadio: WithBoundArgs<typeof TpkValidationRadio, 'changeset' | 'disabled' | 'requiredFields'>;
                TpkRadioGroup: WithBoundArgs<typeof TpkValidationRadioGroup, 'changeset' | 'disabled' | 'requiredFields'>;
                ...
                TpkFile: WithBoundArgs<typeof TpkValidationFile, 'changeset' | 'disabled' | 'requiredFields'>;
                TpkDatepicker: WithBoundArgs<typeof TpkValidationDatepicker, 'changeset' | 'disabled' | 'requiredFields'>;
...
export default class TpkForm<S extends ZodObject, T extends ImmerChangeset<DeepNothing<z.infer<S>>>> extends Component<ChangesetFormSignature<S, T>> {
    requiredFields: string[];
